...
public class GridImageActivity extends BaseActivity {
    ...
    protected Drawable getNavigationIcon() {
        return VectorDrawableUtils.getBackDrawable(this);
    }
        ...
        public void onBindViewHolder(ImageViewHolder holder, int position) {
            ...
            holder.tv_click.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    options.setStatusBarColor(Color.parseColor("#e42046cf"));
                    options.setToolbarColor(Color.parseColor("#3667EC"));
                    options.setToolbarWidgetColor(Color.WHITE);
                    options.setActiveWidgetColor(Color.parseColor("#3667EC"));
